...
export default function ImageListItem({ navigation, item, width, elements, index, photos, setPhotos, showBigPhoto }) {
    ...
    return (
        ...
        >
            <Image source={{
                uri: item.uri,
                width: (width / elements) - 10,
                height: (width / elements) - 10
            }}
                style={styles.image}
            />
